    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignee', models.CharField(default=None, max_length=30)),
                ('assigned_by', models.CharField(default=None, max_length=30)),
                ('description', models.TextField(default=None, max_length=30)),
                ('assigned_epic', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='djapp.epic')),
